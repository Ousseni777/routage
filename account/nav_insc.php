...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="nav_ins.css">
...
<body>
    <div class="banniere">
		...
		<div id="top_header" class="clearfix">
			...
			<div class="gauche">
				<a href="frame.php" class="brand"><span><img src="innovlogo.jfif"></span></a>
			...
			<div class="droite">
                ...
                <a href="inscription.php" id="back_button" target="main"> Register</a>
				<a href="form_login.php" class="teacher" target="main">Login</a>
