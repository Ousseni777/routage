...
<body style=" background-color: rgba(255, 255, 255, 0.3);">
    ...
    <div class="header" style="height: 400px; background-color: rgba(255, 255, 255, 0.3);">
    ...
    <div class="horloge" style="width: 80%; margin-left: 10%">
        <div class="hours">
    ...
    <div class="copyr" style="text-align: center;">@Copyright 2022 SicoM <div>
            ...
            <script>
                ...
                const createLetter = () => {
                    ...
                    console.log(array[wordIndex][letterIndex]);
                    setTimeout(() => {
                        letter.remove();
                    }, 2000)
                }
